...
const AddNewSong = () => {
 ...
 const deleteFileObject = (url ,isImage ) => {
  ...
  return (
    <div className="flex w-880 flex-col items-center justify-center p-4 border border-gray-300 rounded-md">
      ...
      <div  className="flex w-full justify-between flex-wrap items-center gap-4">
        <Buttons filterData={allArtists} flag={"Artist"}/>
        <Buttons filterData={allAlbums} flag={"Album"}/>
        <Buttons filterData={filterByLanguage} flag={"Language"}/>
        <Buttons filterData={filters} flag={"Category"}/>
